            ...
            <div className={styles.contentGrid}>
              <div className={styles.infoColumn}>
                ...
                <div className={styles.helpBox}>
                  ...
                  <p>برای آشنایی کامل‌تر با قابلیت‌ها و معماری محصول، ابتدا صفحه MonoSuite را ببینید؛ اگر درباره استقرار یا تناسب محصول با زیرساخت سازمان سؤال دارید، می‌توانید مستقیماً با تیم هوش‌افزار گفت‌وگو کنید.</p>
                  <Link href="/monosuit/">مشاهده صفحه کامل MonoSuite ←</Link><br />
