...
const portfolio = [
  {
    ...
    text: 'MonoSuite Asset Intelligence محصول بومی هوش‌افزار برای کشف و شناخت دارایی‌ها، تحلیل وضعیت امنیتی، پایش تغییرات و اولویت‌بندی ریسک در محیط‌های سازمانی است.',
    href: '/monosuit/',
...
const principles = [
  ['مسئله پیش از ابزار', 'انتخاب فناوری یا طراحی خدمت از مسئله واقعی، معماری موجود و محدودیت‌های عملیاتی سازمان آغاز می‌شود؛ نه از فهرست محصولات.'],
  ['طراحی برای محیط واقعی', 'راهکار باید در شرایط واقعی زیرساخت، محدودیت‌های شبکه، الزامات محرمانگی و فرآیندهای موجود سازمان قابل استفاده باشد.'],
  ['داده و زمینه برای تصمیم بهتر', 'از شناخت دارایی تا تحلیل رخداد، تلاش می‌کنیم داده خام به زمینه‌ای قابل استفاده برای اولویت‌بندی و تصمیم امنیتی تبدیل شود.'],
  ['توانمندسازی تیم سازمان', 'هدف تنها تحویل فناوری یا گزارش نیست؛ مستندسازی، انتقال دانش و قابل بهره‌برداری بودن خروجی برای تیم داخلی بخشی از کار است.'],
];
